...
/* Lookup method to search for the structure of given name exist or not in  the structure databse */
...
/* Lookup method to search for the object  in the object database */
...
/* Dumping funtion for the object database */
